...
>
    <div class="flex flex-col items-start h-full w-fit max-w-2xl justify-center bg-white
    dark:bg-gray-800 dark:border-gray-600 dark:hover:border-gray-500">
        ...
        <div @click="$refs.input.click()" class="border border-dashed rounded border-gray-500 w-full cursor-pointer">
            <div>
                <div x-show="!isDragging" class="flex items-center bg-gray-50 justify-center gap-2 py-8 px-10 h-full dark:bg-gray-700">
        ...
        <div class="flex justify-between w-full mt-2">
            ...
            <div x-show="isLoading" role="status" class="flex items-center gap-2">
        ...
        <div class="flex flex-wrap gap-x-10 gap-y-2 justify-start w-full mt-5">
            @foreach($files as $file)
                <div class="flex items-center justify-between gap-1 border rounded border-gray-200 w-full h-auto overflow-hidden dark:border-gray-700">
                    <div class="flex items-center gap-1">
                        ...
                        @else
                            <div class="flex justify-center items-center w-10 h-10 bg-gray-100 dark:bg-gray-700">
                        ...
                        <div class="flex flex-col items-start gap-1">
                            <div class="text-left text-slate-900 text-xs dark:text-slate-100 w-[40em] truncate">{{ $file['name'] }}</div>
                            <div class="text-left text-gray-500 text-xs">{{ \Illuminate\Support\Number::fileSize($file['size']) }}</div>
                        </div>
                    </div>
