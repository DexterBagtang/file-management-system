...
new class extends Component {
    ...
    public function calculateFilterCount() : int
    {
        $count = 0;
...
<div>
    ...
    <x-header title="Users" separator progress-indicator>
        ...
        <x-slot:actions>
            <x-button @click="$wire.drawer = true" responsive icon="o-funnel" class="relative">
                Filters
                @if($filter_count != 0)
                <x-badge :value="$filter_count" class="badge-error absolute -right-2 -top-2" />
                @endif
            </x-button>
